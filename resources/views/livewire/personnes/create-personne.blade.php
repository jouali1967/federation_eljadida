          ...
          <div class="col-md-4 ">
            <div class="form-group mb-2">
              ...
              <div class="input-group input-group-sm">
                ...
                <input type="text" id="date_nais_picker" class='form-control @error("date_nais") is-invalid @enderror'
          ...
          <div class="col-md-6">
            <div class="form-group mb-2">
              ...
              <div class="input-group input-group-sm">
                ...
                <input type="text" id="datepicker" class='form-control @error("date_embauche") is-invalid @enderror'
                  placeholder="JJ/MM/AAAA">
              </div>
            </div>
            @error('date_embauche')
            ...
            <div class="form-group mb-2">
              ...
              <div class="input-group input-group-sm">
                ...
                <input id="salaire_base" type="number" class="form-control @error('salaire_base') is-invalid @enderror"
                  wire:model.live="salaire_base" step="0.01" min="0" placeholder="0.00">
              </div>
              @error('salaire_base')
              <div class="invalid-feedback d-block">
                {{ $message }}
            ...
            <div class="form-group mb-2">
              ...
              <div class="input-group input-group-sm">
                ...
                <input id="nbr_enf" type="text" class="form-control  @error('nbr_enf') is-invalid @enderror"
                  wire:model.live="nbr_enf" placeholder="Entrez le nombre enfant">
              </div>
              @error('nbr_enf')
              <div class="invalid-feedback d-block">
                {{ $message }}
